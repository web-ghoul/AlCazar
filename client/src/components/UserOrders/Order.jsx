...
const Order = ({ order, number }) => {
    return (
      ...
      >
        <AccordionSummary
          expandIcon={
            <ExpandMore sx={{ color: (theme) => theme.palette.white }} />
          }
              ...
              <Box className={`grid jcs aic g10`}>
                ...
                <Box className={`flex jcsb aic g20`}>
                  ...
                  <Typography
                    ...
                    className={`fw700`}
                  >
                    EGP {order.deliveryFees}
                  </Typography>
                </Box>
                <Box className={`flex jcsb aic g20`}>
                  <Title title={`Total`} h={"h6"} color={"#fff"} fw={"700"} />
                  <Typography
                    sx={{ color: (theme) => theme.palette.white }}
                    variant="h5"
                    className={`fw700`}
