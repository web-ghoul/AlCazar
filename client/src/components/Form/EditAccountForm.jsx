...
const EditAccountForm = ({ loading, formik }) => {
    const { editableAccountData } = useContext(ProfileContext)
    const [image, setImage] = useState(editableAccountData && editableAccountData.avatar)
    useEffect(() => {
